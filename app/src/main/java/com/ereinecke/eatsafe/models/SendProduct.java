...
public class SendProduct {
    ...
    public void compress(ProductImageField field) {
        switch (field) {
            case NUTRITION:
                this.imgupload_nutrition = Utility.compressImage(this.imgupload_nutrition);
                break;
            case INGREDIENTS:
                this.imgupload_ingredients = Utility.compressImage(this.imgupload_ingredients);
                break;
            case FRONT:
                this.imgupload_front = Utility.compressImage(this.imgupload_front);
                break;
            default:
                //nothing to do
                break;
